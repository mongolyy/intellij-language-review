...
public abstract class SplitFileEditor<E1 extends FileEditor, E2 extends FileEditor> extends UserDataHolderBase implements FileEditor {
    ...
    @NotNull
    private SplitEditorLayout mySplitEditorLayout = ReviewApplicationSettings.getInstance().getReviewPreviewSettings().getSplitEditorLayout();
