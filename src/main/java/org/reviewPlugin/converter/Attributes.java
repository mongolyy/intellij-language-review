...
public class Attributes {
    ...
    public void setAllowUriRead(boolean allowUriRead) {
        this.attributes.put(ALLOW_URI_READ, toReviewConverterFlag(allowUriRead));
    }
    ...
    public void setHardbreaks(boolean hardbreaks) {
        this.attributes.put(HARDBREAKS, toReviewConverterFlag(hardbreaks));
    }
    ...
    public void setCacheUri(boolean cacheUri) {
        this.attributes.put(CACHE_URI, toReviewConverterFlag(cacheUri));
    }
    ...
    public void setHideUriScheme(boolean hideUriScheme) {
        this.attributes.put(HIDE_URI_SCHEME, toReviewConverterFlag(hideUriScheme));
    }
    ...
    public void setSkipFrontMatter(boolean skipFrontMatter) {
        this.attributes.put(SKIP_FRONT_MATTER, toReviewConverterFlag(skipFrontMatter));
    }
    ...
    public void setIgnoreUndefinedAttributes(boolean ignoreUndefinedAttributes) {
        this.attributes.put(IGNORE_UNDEFINED, toReviewConverterFlag(ignoreUndefinedAttributes));
    }
...
/*    public void setTableOfContents(Placement placement) {
    ...
    public void setTableOfContents(boolean toc) {
        this.attributes.put(TOC, toReviewConverterFlag(toc));
    }
    ...
    public void unsetStyleSheet() {
        this.attributes.put(NOT_STYLESHEET_NAME, toReviewConverterFlag(true));
    }
    ...
    public void setLinkCss(boolean linkCss) {
        this.attributes.put(LINK_CSS, toReviewConverterFlag(linkCss));
    }
    ...
    public void setCopyCss(boolean copyCss) {
        this.attributes.put(COPY_CSS, toReviewConverterFlag(copyCss));
    }
    ...
    public void setIconFontRemote(boolean iconFontRemote) {
        this.attributes.put(ICONFONT_REMOTE, toReviewConverterFlag(iconFontRemote));
    }
    ...
    public void setDataUri(boolean dataUri) {
        this.attributes.put(DATA_URI, toReviewConverterFlag(dataUri));
    }
    ...
    public void setSectionNumbers(boolean sectionNumbers) {
        this.attributes.put(SECTION_NUMBERS, toReviewConverterFlag(sectionNumbers));
    }
    ...
    public void setLinkAttrs(boolean linkAttrs) {
        this.attributes.put(LINK_ATTRS, toReviewConverterFlag(linkAttrs));
    }
    ...
    public void setNoFooter(boolean noFooter) {
        this.attributes.put(NO_FOOTER, toReviewConverterFlag(noFooter));
    }
    ...
    public static String toReviewConverterFlag(boolean flag) {
        return flag ? "" : null;
    }
